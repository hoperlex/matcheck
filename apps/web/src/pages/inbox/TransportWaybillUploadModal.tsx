  ...
  return (
    ...
    >
      <Alert
        ...
        description="Распознаётся ТОЛЬКО печатная Транспортная накладная (форма РФ 2116). Рукописные накладные, паспорта качества и прочие документы из пакета игнорируются."
      />
