...
export function UserProfileModal({
  ...
  return (
    <Modal
      ...
      width={520}
      centered
      // Две формы подряд (профиль + смена пароля) выше вьюпорта на невысоких
      // экранах: без ограничения окно уезжало за нижний край и до кнопок
      // «Выход»/«Закрыть» приходилось скроллить страницу. Теперь скроллится
      // только тело, а header и footer видны всегда.
