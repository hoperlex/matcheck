  ...
  properties: {
    ...
    items: {
      ...
      items: {
        ...
        properties: {
          nameRaw: { type: 'string' },
          // rowNo — порядковый номер позиции из графы 1, как напечатан в
          // бланке. По нему сверяется целостность списка: пропущенная или
          // задвоенная строка видна даже когда суммы сошлись.
          rowNo: { type: ['integer', 'null'] },
