...
// Второй проход по форме 1-Т. Двух страниц ей мало: у 1-Т товарный раздел
// идёт первым, транспортный — вторым, а таблица позиций нередко переносится
// на третий лист. Боевой «Товарно-транспортная накладная № БП-1414» — ровно
// такой случай: страниц три, до модели доходили две. Предел поднят только
// для второго прохода; первый по-прежнему видит две страницы и работает
// в точности как раньше.
export const WAYBILL_1T_MAX_PAGES_FOR_OPENROUTER = 4;
