...
export const ShipmentSchema = z.object({
  ...
  // admin/manager/monitor — для прочих ролей сервер отдаёт их null (см. buildShipmentDto).
  ...ReviewFieldsShape,
...
export const ShipmentUpsertSchema = z.object({
  ...
  /**
   * Момент, когда инспектор фактически подтвердил отгрузку на планшете
   * (завершил 2 Этап или ручной вынос). Опционально: сборки до 1.0.33 его не
